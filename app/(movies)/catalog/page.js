...
export const metadata = buildMetadata({
  title: "Hentai Catalog — Browse All Series, Genres & Releases",
  description:
    "Browse the full YourHentaiTV catalog. Filter hentai series by genre, popularity, most viewed and top rated. Find censored and uncensored titles and stream every episode online free in HD.",
  path: "/catalog",
  keywords: [
    "hentai catalog",
    "hentai list",
